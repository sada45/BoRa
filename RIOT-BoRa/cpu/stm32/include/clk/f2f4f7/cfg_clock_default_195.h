 ...
 *              BoRa: used for receive the 2.4G Native LoRa (195)
 *
...
#ifndef CLK_F2F4F7_CFG_CLOCK_DEFAULT_195_H
#define CLK_F2F4F7_CFG_CLOCK_DEFAULT_195_H
...
/**
 * @name    Clock PLL settings (195MHz)
 * @{
 */
...
#define CONFIG_CLOCK_APB1_DIV           (4)         /* max 48.75MHz */
#endif
#ifndef CONFIG_CLOCK_APB2_DIV
#define CONFIG_CLOCK_APB2_DIV           (2)         /* max 97.5MHz */
#endif
/** @} */
