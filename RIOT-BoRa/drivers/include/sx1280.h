 ...
 */
 ...
 // #define SX1280_CHANNEL_DEFAULT           (2088000000UL)             /**< Default channel frequency, 2088MHz */
 // #define SX1280_CHANNEL_DEFAULT           (2750000000UL)             /**< Default channel frequency, 2750MHz */
 // #define SX1280_CHANNEL_DEFAULT           (2380000000UL)             /**< Default channel frequency, 2380MHz */
 #define SX1280_CHANNEL_DEFAULT           (2390000000UL + 300000UL)             /**< Default channel frequency, 2380.2MHz, ubertooth, 2e5Hz CFO */
 
 // 2753, 1/2
 // #define SX1280_RADIO_TX_POWER            (SX1280_PWR_MAX)           /**< Radio power in dBm */
 #define SX1280_RADIO_TX_POWER            (-2)           /**< Radio power in dBm */
 /** @} */
