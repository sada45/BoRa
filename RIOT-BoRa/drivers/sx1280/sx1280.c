...
{
    /* default parameters */
    DEBUG("[driver/sx1280/sx1280.c] sx1280_init_default_config, CONFIG_PLD_IS_FIX_DEFAULT:%d, CONFIG_PLD_LEN_IN_BYTES_DEFAULT:%d\n", CONFIG_PLD_IS_FIX_DEFAULT, CONFIG_PLD_LEN_IN_BYTES_DEFAULT);
    ...
    DEBUG("[sx1280]CONFIG_LORA_PREAMBLE_LENGTH_DEFAULT:%d\n", CONFIG_LORA_PREAMBLE_LENGTH_DEFAULT);
...
{
    DEBUG("[sx1280]: sx1280_set_spreading_factor:%d\n", sf);
