...
void print(void)
{
    ...
    DEBUG("[Main] channel: %"PRIu32"Hz\n", sx1280_get_channel(&sx1280));
    DEBUG("[Main] Bandwidth: %"PRIu32" Hz\n", sx1280_get_bandwidth(&sx1280));
    DEBUG("[Main] Spreading factor: %d\n", sx1280_get_spreading_factor(&sx1280));
    DEBUG("[Main] Coding rate: %d\n", sx1280_get_coding_rate(&sx1280));
    DEBUG("[Main] Payload Length: %d\n", sx1280_get_lora_payload_length(&sx1280));

    DEBUG("[Main] CRC: %d\n", sx1280_get_lora_crc(&sx1280));
    DEBUG("[Main] IQ Invert: %d\n", sx1280_get_lora_iq_invert(&sx1280));
    // DEBUG("[Main] Sync word: %d\n", sx1280_)
    return;
}
