...
// payload length
#ifndef CONFIG_PLD_LEN_IN_BYTES_DEFAULT
#define CONFIG_PLD_LEN_IN_BYTES_DEFAULT    (8U)
#endif
#ifndef CONFIG_PLD_IS_FIX_DEFAULT
#define CONFIG_PLD_IS_FIX_DEFAULT      (true)
#endif
...
#elif IS_ACTIVE(CONFIG_LORA_CR_DEFAULT_CR_4_4)
#define CONFIG_LORA_CR_DEFAULT                      (LORA_CR_4_4)
#endif

#ifndef CONFIG_LORA_CR_DEFAULT
#define CONFIG_LORA_CR_DEFAULT                      (LORA_CR_4_8)
// #define CONFIG_LORA_CR_DEFAULT                      (0)
