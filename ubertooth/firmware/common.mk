...
# Default target.
all: begin gccversion sizebefore moveback build showtarget sizeafter moveall end 
...
moveback:
	@-mv $(OBJDIR)/$(OUTDIR)/*.d $(OBJDIR)/$(OUTDIR)/*.lst $(OBJDIR)/$(OUTDIR)/*.o $(OBJDIR)/$(OUTDIR)/*.map $(OBJDIR)/$(OUTDIR)/*.sym $(OBJDIR)/$(OUTDIR)/*.srec $(OBJDIR)/$(OUTDIR)/*.elf $(OBJDIR)/$(OUTDIR)/*.bin $(OBJDIR)/$(OUTDIR)/*.hex $(OBJDIR)/$(OUTDIR)/*.lss $(OBJDIR)/$(OUTDIR)/*.dfu -t $(OBJDIR)/

moveall:
	@echo move to $(OUTDIR)
	@mv $(OBJDIR)/*.d $(OBJDIR)/*.lst $(OBJDIR)/*.o $(OBJDIR)/*.map $(OBJDIR)/*.sym $(OBJDIR)/*.srec $(OBJDIR)/*.elf $(OBJDIR)/*.bin $(OBJDIR)/*.hex $(OBJDIR)/*.lss $(OBJDIR)/*.dfu -t $(OBJDIR)/$(OUTDIR)/
...
clean_list clean_binary doxygen moveall moveback
